...
import classes.ComprovadorTextField;
...
public class AddUser extends javax.swing.JFrame {
    ...
    private ComprovadorTextField ctf;
    
    public AddUser() {
        
        initComponents();
        ctf = new ComprovadorTextField(jTextField1);
        ctf.add(jTextField2);
        ctf.add(jTextField3);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Agregar Usario");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (ctf.comprobarTexto()) {
            String name = jTextField1.getText();
            String lastName = jTextField2.getText();
            String ageS = jTextField3.getText();
            try {
                int age = Integer.parseInt(ageS);
                ExcelConnection.addUser(name, lastName, age);
                JOptionPane.showMessageDialog(null,"Usuario agregado con éxito");
                
            } catch (NumberFormatException | SQLException e) {
                jTextField3.setBackground(Color.RED);
                JOptionPane.showMessageDialog(null,"En la casilla de edad solo son permitidos numeros");
